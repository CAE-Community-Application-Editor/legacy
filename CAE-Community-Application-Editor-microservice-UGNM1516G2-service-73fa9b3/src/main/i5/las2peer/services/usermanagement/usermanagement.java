...
@Api
@SwaggerDefinition(
    info = @Info(title = "UGNM1516G2 service", version = "0.1",
        description = "A LAS2peer microservice generated by the CAE.",
        termsOfService = "none",
        contact = @Contact(name = "sebastianvassen", email = "CAEAddress@gmail.com") ,
        license = @License(name = "BSD",
            url = "https://github.com/CAE-Community-Application-Editor/microservice-UGNM1516G2-service/blob/master/LICENSE.txt") ) )
public class usermanagement extends Service {
  ...
  public HttpResponse createUser(@ContentParam String user) {
    ...
    if(BadRequestResponse_condition) {
      ...
      HttpResponse BadRequestResponse = new HttpResponse(BadRequest.toJSONString(), HttpURLConnection.HTTP_BAD_REQUEST);
  ...
  public HttpResponse updateUser(@ContentParam String user) {
    JSONObject user_JSON = (JSONObject) JSONValue.parse(user);
    // userResponse
    boolean userResponse_condition = true;
    if(userResponse_condition) {
